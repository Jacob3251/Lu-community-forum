                ...
                <div className="absolute bottom-[-18%] md:bottom-[-42%] left-[31%]  sm:left-[40%] md:left-[10%] ">
                  ...
                  <div className="flex md:flex-row flex-col justify-center items-center">
                    ...
                    <div className="ml-5 hidden md:block">
                      {profile.length !==0 &&<h3 className=" text-2xl font-bold text-black">
                        {profile[0].name}
                      </h3>}
                      {/* follow button  */}
                      <button onClick={()=>setFollow(!follow)} className={`px-3 inline-block py-1 mt-2 font-semibold rounded-md hover:scale-110 duration-200 ${follow ? " bg-[#3c2317] text-white":"bg-white text-[#3c2317]"}`}>
